...
class AlphanumericComparatorTest {
  ...
  @Test
  void collatorSort() {
    List<String> list = Stream.of("b", "e", "f", "ě", "è", "g", "k").sorted(comparator).toList();
  ...
  void collatorSortWords() {
    List<String> list =
        Stream.of(
                "sèle", "solo", "solè", "sola", "soli", "sole", "sold", "sila", "silè", "sölo",
                "sulo", "sylo", "soly")
            .sorted(comparator)
            .toList();
    ...
    assertThat(list)
        .containsExactly(
            "sèle", "sila", "silè", "sola", "sold", "sole", "solè", "soli", "solo", "soly", "sölo",
            "sulo", "sylo");
  }
  ...
  void fileNameSort() {
    ...
    assertThat(list)
        .containsExactly(
            "file-01.doc", "file-2.doc", "file-3.doc", "file-03.doc", "file-10.doc", "file-20.doc");
  }
